...
class _PedidosScreenState extends State<PedidosScreen> {
  ...
  Future<void> _mostrarDialogoNovoPedido() async {
    ...
    Future<void> adicionarItem() async {
      ...
      await showDialog(
        ...
        builder: (_) {
          ...
          final dialogWidth =
              screenWidth > 800 ? screenWidth * 0.5 : screenWidth * 0.9;
          final dialogHeight =
                        ...
                        ElevatedButton(
                          onPressed: () {
                            if (pizzaSelecionada1 != null) {
                              final pizza1 = pizzasSnapshot.docs
                                  .firstWhere((p) => p.id == pizzaSelecionada1!);
                              ...
                              if (pizzaSelecionada2 != null) {
                                final pizza2 = pizzasSnapshot.docs
                                    .firstWhere((p) => p.id == pizzaSelecionada2!);
    ...
    await showDialog(
      ...
      builder: (_) {
        final screenWidth = MediaQuery.of(context).size.width;
        final dialogWidth =
            screenWidth > 800 ? screenWidth * 0.6 : screenWidth * 0.9;
        final dialogHeight =
            screenWidth > 800 ? MediaQuery.of(context).size.height * 0.8 : null;
                        ...
                        onPressed: () async {
                          if (clienteSelecionado != null &&
                            ...
                            final clienteDoc = clientesSnapshot.docs
                                .firstWhere((c) => c.id == clienteSelecionado);
  ...
  Stream<QuerySnapshot> getPedidosStream() {
    Query query =
        _db.collection('pedidos').orderBy('criado_em', descending: true);
